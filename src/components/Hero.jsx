...
function Hero() {
  return (
    <section id="home" className="relative overflow-hidden bg-gradient-to-br from-endeavour-dark via-endeavour-blue to-endeavour-dark" style={{height: '100vh'}}>
      ...
      <div className="relative max-w-7xl mx-auto px-4 h-full grid lg:grid-cols-2 gap-6 items-center py-8 md:py-12">
        <div className="text-white text-center lg:text-left">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-3 md:mb-4">
            Endeavour Academy<br className="hidden sm:block" />
            <span className="block sm:inline">Where Potential Shines</span>
          </h1>
          
          <p className="text-sm md:text-base lg:text-lg text-white/90 mb-4 md:mb-6 leading-relaxed max-w-2xl mx-auto lg:mx-0">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center lg:justify-start">
            <button className="bg-white text-slate-800 px-5 md:px-6 py-2 md:py-3 rounded-lg font-bold text-sm md:text-base shadow-lg hover:shadow-xl hover:scale-105 transition-all">
              LEARN MORE
            </button>
            <button className="bg-transparent border-2 border-white text-white px-5 md:px-6 py-2 md:py-3 rounded-lg font-bold text-sm md:text-base hover:bg-white hover:text-slate-800 transition-all">
              SCHEDULE VISIT
            </button>
          </div>
        </div>
        ...
        <div className="relative flex justify-center items-center order-first lg:order-last">
          <div className="relative w-full max-w-sm md:max-w-md">
            <img
              ...
              className="w-full h-auto max-h-[50vh] md:max-h-[60vh] object-contain rounded-2xl md:rounded-3xl shadow-2xl"
            />
