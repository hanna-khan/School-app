            ...
            <div key={classItem.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-6 space-y-4">
                <div className="flex justify-between space-x-2">
                  <div className="bg-orange-100 text-orange-800 px-3 py-2 rounded-lg border border-dashed border-orange-300 text-center flex-1">
                    <div className="text-sm font-bold">{classItem.classSize}</div>
                    <div className="text-xs">Class Size</div>
                  </div>
                  <div className="bg-green-100 text-green-800 px-3 py-2 rounded-lg border border-dashed border-green-300 text-center flex-1">
                    <div className="text-sm font-bold">{classItem.classTime}</div>
                    <div className="text-xs">Class Time</div>
                  </div>
                  <div className="bg-purple-100 text-purple-800 px-3 py-2 rounded-lg border border-dashed border-purple-300 text-center flex-1">
